...
//[/user-inheritance]
{
   ...
   public MyModule( long moduleID, VoltageObjects voltageObjects )
   {
      ...
      AddComponent( LED1 );
      LED1.SetWantsMouseNotifications( true );
      LED1.SetPosition( 51, 114 );
      LED1.SetSize( 60, 60 );
      LED1.SetSkin( "Blue And Red" );

      textLabel1 = new VoltageLabel( "textLabel1", "textLabel1", this, "Text" );
      AddComponent( textLabel1 );
      textLabel1.SetWantsMouseNotifications( false );
      textLabel1.SetPosition( 27, 194 );
      ...
      textLabel1.SetBkColor( new Color( 255, 255, 255, 0 ) );
      textLabel1.SetBorderColor( new Color( 255, 255, 255, 0 ) );
      ...
      slider1.SetPosition( 38, 247 );
      slider1.SetSize( 19, 49 );
      slider1.SetSkin( "Skinny Red" );
      slider1.DisplayValueInPercent( false );



      canBeBypassed = false;
      SetSkin( "9e450fc2eff64406bd99cc37517d3898" );
   }
   ...
   public boolean Notify( VoltageComponent component, ModuleNotifications notification, double doubleValue, long longValue, int x, int y, Object object )
   {
      ...
      switch( notification )
      {
         ...
         {
            // So coordginates are from the point of view of the control being clicked. That makes a refreshing change!
            VoltageMouseKeyFlags vmkf = (VoltageMouseKeyFlags)object;
            if (vmkf.IsLeftButtonDown() && startY >= 0) {
               double variation = (double)(startY - y) / 30 + initialValue;
               if (variation < 0)
                  variation = 0;
               else if (variation > 1)
                  variation = 1;
                  
               LED1.SetValue(variation);
               textLabel1.SetText("y " + y + " variation" + variation);
            }
         }
         break;
